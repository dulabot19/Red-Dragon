...
*👽 මම ᴏɴʟɪɴᴇ යකො මොකද්ද මගෙන් කෙරෙන්න ඔන ඉතිම්✌🏻*

*🤷‍♀️How can I help you?😉*

*🤫බොසාගෙ කැල්ල ᴤʜᴀᴤʜɪᴋᴀʟᴀ👩🏻‍🦳💞*
...
ᴘᴏᴡᴇʀᴅ ʙʏ ᴅᴜʟᴀ` //Costomize Alive Message (type your message in `` )
...
global.ownername = "☃️ᴅᴜʟᴀ🏅" // owner name
global.ytname = "" // yt chanel name
global.socialm = "දැන් සැපද" // github or insta name
global.location = "Sri lanka, Mathara" // location

//bot body 
global.alivepic = `https://ibb.co/KsQVNwp` // alive picture \\ use "https://ibb.com" to upload photos. < 1 MB
...
global.botname = '💖ᴅ_ɴʏɴ🇱🇰 - 𝘉𝘖𝘛' //ur bot name
global.packname = "ᴅᴜʟᴀ(ᴅ_ɴʏɴ-ʙᴏᴛ)" // sticker packname
...
global.rep = { // All Replies = 145
    ...
    K145: '🫡🫠🤝',
    K146: '🌞නොදැනීම එලිවෙලා නෙද සගෝ🐔 👩🏻‍🦳මෙ හිමිදිරි උදැසන කුක්කූ ටිකක් තිබ්බනම් මරු නේද 🤤 ඔබ සැමට  සුබ උදැසනක්💞',
